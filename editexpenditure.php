...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE users SET  expenditure='$expenditure', ex_reason='$ex_reason', m_status='$m_status' WHERE id=$id";
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="text-center text-bold">ຟອມແກ້ໄຂຂໍ້ມູນລາຍຈ່າຍ</h1>
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">ການແກ້ໄຂຂໍ້ມູນລາຍຈ່າຍ</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="expenditure" class="form-control"
                                                        id="exampleInputEmail1" value="<?php echo $row['expenditure'] ?>"
                                                        required placeholder="ຈຳນວນເງິນ">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">ເຫດຜົນ</label>
                                                    <input type="text" name="ex_reason" class="form-control"
                                                        id="exampleInputPassword1"
                                                        value="<?php echo $row['ex_reason'] ?>" required
                                                        placeholder="ເຫດຜົນໃຊ້ຈ່າຍ">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
