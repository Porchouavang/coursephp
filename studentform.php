...
<div class="wrapper">
  ...
  $sql = "SELECT * FROM users WHERE is_delete=0 AND role=4";
  ...
  <section class="content-header">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="text-center text-bold">ຟອມພໍ່ແມ່</h1>
                <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">ການເພີ່ມພໍ່ແມ່</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <div class="card-body">
                 ...
                 <div class="row">
                 <div class="form-group">
                   <label for="exampleInputEmail1">ຊື່ພໍ່</label>
                   <input type="text" name="f_name" class="form-control" id="exampleInputEmail1" required placeholder="ຊື່ພໍ່">
                   </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 <div class="form-group">
                   <label for="exampleInputPassword1">ເບີໂທພໍ່</label>
                   <input type="text" name="f_phone" class="form-control" id="exampleInputPassword1" required placeholder="ເບີໂທພໍ່">
                 </div>
                 </div>
                 <div class="row">
                 <div class="form-group">
                   <label for="exampleInputEmail1">ຊື່ແມ່</label>
                   <input type="text" name="m_name" class="form-control" id="exampleInputEmail1" required placeholder="ຊື່ແມ່">
                   </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 <div class="form-group">
                   <label for="exampleInputPassword1">ເບີໂທແມ່</label>
                   <input type="text" name="m_phone" class="form-control" id="exampleInputPassword1" required placeholder="ເບີໂທແມ່">
                 </div>
                 </div>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="editparents.php?id=<?php echo $row['id']?>" class="btn btn-warning"><i class="fas fa-edit"></i></a><a href="#" onclick="confirmDelete(<?php echo $row['id'];?>)" class="btn btn-danger"><i class="fas fa-times"></i></a></td>
                      </tr>
                      <?php }?>
                    </tbody>
                  </table>
...
<script>
    function confirmDelete($id) {
      ...
      Swal.fire({
        ...
        window.location.href = 'deleteparents.php?id=' + $id;
      });
        }
      });
    }
