            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h2 class="text-center text-primary text-bold">ໃບບິນນັກຮຽນ</h2> 
                        </div>
                        <div class="col-md-3">
                                ...
                                <thead>
                                  <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><b>ຊື່ພໍ່:</b> <?php echo $row['f_name'];?></td>
                                    </tr>
                                    <tr>
                                        <td><b>ເພດ:</b> <?php echo $row['gender'];?></td>
                                        <td><b>ເບີໂທພໍ່:</b> <?php echo $row['f_phone'];?></td>
                                    </tr>
                                    <tr>
                                        <td><b>ອີເມວ:</b> <?php echo $row['email'];?></td>
                                        <td><b>ຊື່ແມ່:</b> <?php echo $row['m_name'];?></td>
                                    </tr>
                                    <tr>
                                        <td><b>ອາຍຸ:</b> <?php echo $row['age'];?></td>
                                        <td><b>ເບີໂທແມ່:</b><?php echo $row['m_phone'];?></td>
                                    </tr>
                                    <tr>
                                        <td><b>ບ້ານ:</b> <?php echo $row['village'];?></td>
                                        <td><b>ຄ່າຮຽນ:</b> <?php echo $row['income'];?> ₭</td>
                                    </tr>
                                    <tr>
                                        <td><b>ເມືອງ:</b> <?php echo $row['district'];?></td>
                                        <td><b>ສະຖານະ:</b> <?php echo $row['status'];?></td>
                                    </tr>
                                    <tr>
