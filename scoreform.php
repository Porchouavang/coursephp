...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        $sql = "SELECT * FROM scores WHERE is_delete=0 ORDER BY s_score DESC";
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-4">
                            <h1 class="text-center text-bold">ຟອມຄະແນນ</h1>
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">ການເພີ່ມຄະແນນ</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="insertscore.php">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group ml-5">
                                                <label for="exampleInputEmail1">ຄະແນນ</label>
                                                <input type="number" name="s_score" class="form-control"
                                                    id="exampleInputEmail1" required placeholder="ກະລຸນາປ້ອນຄະແນນ">
                                            </div>
                                        </div>
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            ...
                                            <td><a href="editadmin.php?id=<?php echo $row['id'] ?>"
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.fire({
                        ...
                        window.location.href = 'deletescore.php?id=' + $id;
                    });
                }
            });
        }
