...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "UPDATE users SET  email='$email', password='$hashPassword', f_name='$f_name', f_phone='$f_phone', m_name='$m_name', m_phone='$m_phone' WHERE id=$id";
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="text-center text-bold">ຟອມແກ້ໄຂຂໍ້ມູນພໍ່ແມ່</h1>
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">ການແກ້ໄຂຂໍ້ມູນພໍ່ແມ່</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="f_name" class="form-control" id="exampleInputEmail1" value="<?php echo $row['f_name'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">ເບີໂທພໍ່</label>
                                                    <input type="text" name="f_phone" class="form-control" id="exampleInputPassword1" value="<?php echo $row['f_phone'] ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="m_name" class="form-control" id="exampleInputEmail1" value="<?php echo $row['m_name'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1">ເບີໂທແມ່</label>
                                                    <input type="text" name="m_phone" class="form-control" id="exampleInputPassword1" value="<?php echo $row['m_phone'] ?>" required placeholder="*******">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
