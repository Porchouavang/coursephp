...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        $sql = "SELECT * FROM classes WHERE is_delete=0 ";
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <h1 class="text-center text-bold">ຟອມຫ້ອງຮຽນ</h1>
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">ການເພີ່ມຫ້ອງຮຽນ</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                        ...
                                        <div class="row">
                                            <div class="form-group ml-4">
                                                ...
                                                <input type="text" name="class_name" class="form-control"
                                                    id="exampleInputEmail1" required placeholder="ກະລຸນາປ້ອນຊື່ຫ້ອງຮຽນ">
                                            </div>
                                            <div class="form-group ml-4">
                                                ...
                                                <select name="subject_id" id="" class="form-control">
                                                    <?php
                                                        include("./includes/db.php");
                                                        $sql2 = "SELECT subjects.subject_name FROM subjects WHERE is_delete = 0";
                                                        $result2 = mysqli_query($conn, $sql2);
                                                        while ($row2 = mysqli_fetch_assoc($result2)){
                                                            echo '<option value="'. $row2['subject_name'] . '">'.$row2['subject_name'].'</option>';
                                                        }
                                                    ?>
                                                </select>
                                            </div>
                                            <div class="form-group ml-4">
                                                ...
                                                <select name="teacher_id" id="" class="form-control">
                                                    <?php
                                                        include("./includes/db.php");
                                                        $sql3 = "SELECT users.first_name FROM users WHERE is_delete = 0 AND role = 3";
                                                        $result3 = mysqli_query($conn, $sql3);
                                                        while ($row3 = mysqli_fetch_assoc($result3)){
                                                            echo '<option value="'. $row3['first_name'] . '">'.$row3['first_name'].'</option>';
                                                        }
                                                    ?>
                                                </select>
                                            </div>
                        ...
                        <div class="col-md-6" style="overflow:auto;">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php 
                                    include('./includes/db.php');
                                    $sql4 = "SELECT classes.id, classes.class_name, subjects.subject_name, users.first_name as teacher_name FROM classes JOIN subjects ON classes.subject_id = subjects.s_ID JOIN users ON classes.teacher_id = users.id WHERE classes.is_delete = 0";
                                    ...
                                    while ($row4 = mysqli_fetch_assoc($result4)) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row4['teacher_name'] ?></td>
                                            <td><a href="editclass.php?id=<?php echo $row4['id'] ?>"
                                                    class="btn btn-warning"><i class="fas fa-edit"></i></a><a href="#"
                                                    onclick="confirmDelete(<?php echo $row4['id']; ?>)"
