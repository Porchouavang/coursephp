  ...
  <section class="content-header">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="text-center text-bold">ນັກສຶກສາລະຫັດທີ່: <?php echo $row['id']?></h1>
                <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">ການສະແດງຂໍ້ມູນ</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <div class="d-flex justify-content-between">
                      <p></p>
                      <p><a href="studentprintpdf.php?id=<?php echo$row['id'];?>" class="btn btn-success btn-sm"><i class="fas fa-print mr-1"></i>Print PDF</a></p>
              </div>
                <p class="text-center">
                <?php $filePath = $row["profile"];
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="row form-group ml-1">
                            <p class="text-bold">ຊື່ພໍ່ : </p> <?php echo$row['f_name'];?>
                        </div>
                        <div class="row form-group ml-1">
                            <p class="text-bold">ເບີໂທພໍ່ : </p> <?php echo$row['f_phone'];?>
                        </div>
                        <div class="row form-group ml-1">
                            <p class="text-bold">ຊື່ແມ່ : </p> <?php echo$row['m_name'];?>
                        </div>
                        <div class="row form-group ml-1">
                            <p class="text-bold">ເບີໂທແມ່ : </p> <?php echo$row['m_phone'];?>
                        </div>
                        <div class="row form-group ml-1">
                            <p class="text-bold">ຄ່າຮຽນ : </p> <?php echo$row['income'];?> ກີບ
                        </div>
                        <div class="row form-group ml-1">
                            <p class="text-bold">ສະຖານະ : </p> <?php echo$row['status'];?>
                        </div>
                        <div class="row form-group ml-1">
                            <p class="text-bold">ຈ່າຍດ້ວຍ : </p> <?php echo$row['m_status'];?>
                        </div>
                    </div>
